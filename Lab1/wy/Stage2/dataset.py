...
full_info = pd.read_csv('final_info.csv')
...
hidden = [128, 64, 32]
dropout = 0
feature_col = [[{"feature": feature_} for feature_ in dense_feature]] + [[{"feature": feature_, "feature_num": full_info[feature_].nunique(), "embedding_dim": 8} for feature_ in sparse_feature]]
