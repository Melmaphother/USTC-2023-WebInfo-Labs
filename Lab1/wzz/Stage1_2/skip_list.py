...
if __name__ == "__main__":
    with open(r"D:\web_lab\WebInfo\Lab1\wzz\Stage1_2\book_participle.json","r",encoding="UTF-8") as fin:
    ...
    with open(r"D:\web_lab\WebInfo\Lab1\wzz\Stage1_2\skip_dict.json","w",encoding="UTF-8") as fout:
